...
#include "hb-blob.h"
// hb-subset does not support --help
// hb-subset does not support --version
<<<<<<< HEAD
int
...
{
  return 0;
>>>>>>> 61ffa975... Add enough nop files that we can build and end up with an hb-subset, albeit one that does nothing
=======
int
main (int argc, char **argv)
{
